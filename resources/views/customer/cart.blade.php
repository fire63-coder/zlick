                    ...
                    <form action="" method="post">
                        ...
                        <div class="cart-buttons">
                            <ul>
                                ...
                                <li><a href="{{route('customer.home')}}" class="btn btn-primary">Continue Shopping</a></li>
                                <li><a href="{{route('customer.checkout')}}" class="btn btn-primary">Proceed to Checkout</a></li>
                            </ul>
                        </div>
                    </form>
                </div>
