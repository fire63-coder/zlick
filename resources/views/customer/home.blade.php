...
<div id="bootstrap-touch-slider" class="carousel bs-slider fade control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="false" >
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active" style="background-image:url(frontend/assets/uploads/slider-1.png);">
        ...
        <div class="item " style="background-image:url(frontend/assets/uploads/slider-2.jpg);">
            <div class="bs-slider-overlay"></div>
            <div class="container">
                <div class="row">
                    <div class="slide-text slide_style_center">
        ...
        <div class="item " style="background-image:url(frontend/assets/uploads/slider-3.png);">
            <div class="bs-slider-overlay"></div>
            <div class="container">
                <div class="row">
...
<div class="service bg-gray">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="item">
                    <div class="photo"><img src="frontend/assets/uploads/service-5.png" width="150px" alt="Easy Returns"></div>
                    <h3>Easy Returns</h3>
                    <p>
            ...
            <div class="col-md-4">
                <div class="item">
                    <div class="photo"><img src="frontend/assets/uploads/service-6.png" width="150px" alt="Free Shipping"></div>
                    <h3>Free Shipping</h3>
                    <p>
            ...
            <div class="col-md-4">
                <div class="item">
                    <div class="photo"><img src="frontend/assets/uploads/service-7.png" width="150px" alt="Fast Shipping"></div>
                    <h3>Fast Shipping</h3>
                    <p>
            ...
            <div class="col-md-4">
                <div class="item">
                    <div class="photo"><img src="frontend/assets/uploads/service-8.png" width="150px" alt="Satisfaction Guarantee"></div>
            ...
            <div class="col-md-4">
                <div class="item">
                    <div class="photo"><img src="frontend/assets/uploads/service-9.png" width="150px" alt="Secure Checkout"></div>
            ...
            <div class="col-md-4">
                <div class="item">
                    <div class="photo"><img src="frontend/assets/uploads/service-10.png" width="150px" alt="Money Back Guarantee"></div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="product-carousel">
                    <div class="item">
                        <div class="thumb">
                            <div class="photo" style="background-image:url(frontend/assets/uploads/product-featured-84.jpg);"></div>
                    ...
                    <div class="item">
                        <div class="thumb">
                            <div class="photo" style="background-image:url(frontend/assets/uploads/product-featured-86.jpg);"></div>
                            <div class="overlay"></div>
                        </div>
                        <div class="text">
                    ...
                    <div class="item">
                        <div class="thumb">
                            <div class="photo" style="background-image:url(frontend/assets/uploads/product-featured-95.jpg);"></div>
                            <div class="overlay"></div>
                        </div>
                        <div class="text">
                    ...
                    <div class="item">
                        <div class="thumb">
                            <div class="photo" style="background-image:url(frontend/assets/uploads/product-featured-96.jpg);"></div>
                            <div class="overlay"></div>
                        </div>
                        <div class="text">
                    ...
                    <div class="item">
                        <div class="thumb">
                            <div class="photo" style="background-image:url(frontend/assets/uploads/product-featured-97.jpg);"></div>
                            <div class="overlay"></div>
                        </div>
                        <div class="text">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="product-carousel">
                    <div class="item">
                        <div class="thumb">
                            <div class="photo" style="background-image:url(frontend/assets/uploads/product-featured-102.jpg);"></div>
                            <div class="overlay"></div>
                        </div>
                        <div class="text">
                    ...
                    <div class="item">
                        <div class="thumb">
                            <div class="photo" style="background-image:url(frontend/assets/uploads/product-featured-101.jpg);"></div>
                            <div class="overlay"></div>
                        </div>
                        <div class="text">
                    ...
                    <div class="item">
                        <div class="thumb">
                            <div class="photo" style="background-image:url(frontend/assets/uploads/product-featured-100.jpg);"></div>
                            <div class="overlay"></div>
                        </div>
                        <div class="text">
                    ...
                    <div class="item">
                        <div class="thumb">
                            <div class="photo" style="background-image:url(frontend/assets/uploads/product-featured-99.jpg);"></div>
                            <div class="overlay"></div>
                        </div>
                        <div class="text">
                    ...
                    <div class="item">
                        <div class="thumb">
                            <div class="photo" style="background-image:url(frontend/assets/uploads/product-featured-98.jpg);"></div>
                            <div class="overlay"></div>
                        </div>
                        <div class="text">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="product-carousel">
                    ...
                    <div class="item">
                        <div class="thumb">
                            <div class="photo" style="background-image:url(frontend/assets/uploads/product-featured-92.jpg);"></div>
                            <div class="overlay"></div>
                        </div>
                        <div class="text">
                    ...
                    <div class="item">
                        <div class="thumb">
                            <div class="photo" style="background-image:url(frontend/assets/uploads/product-featured-94.jpg);"></div>
                            <div class="overlay"></div>
                        </div>
                        <div class="text">
