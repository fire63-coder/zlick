                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <ul class="prod-slider">
                                    <li style="background-image: url(assets/uploads/product-featured-86.jpg);">
                                        <a class="popup" href="{{asset('frontend/assets/uploads/product-featured-86.jpg')}}"></a>
                                    </li>
                                    <li style="background-image: url(assets/uploads/product_photos/112.jpg);">
                                        <a class="popup" href="{{asset('frontend/assets/uploads/product_photos/112.jpg')}}"></a>
                                    </li>
                                    <li style="background-image: url(assets/uploads/product_photos/113.jpg);">
